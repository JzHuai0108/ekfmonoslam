...
% measurement.
% gnomegae, $g^e$, gravity in ECEF frame, 3-vector, and $w_{ie}^e$, 3-vector,
% if all of them set 0, this amount to integration in inertial frame

function rvqs0_new=strapdown_local_quat(rvqs0, rqs02e, a, w, dt, gnomegae)
rvqs0_new=zeros(size(rvqs0));
gs0=quatrot_v000(rqs02e(4:7), gnomegae(1:3), 1); % gravity in s0 frame
wie2s0=quatrot_v000(rqs02e(4:7), gnomegae(4:6),1);
%Update attitude
...
vel_inc2=(gs0+2*cross(rvqs0(4:6),wie2s0)-(skew(wie2s0))^2*rvqs0(1:3))*dt;
